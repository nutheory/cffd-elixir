defmodule Stockex.Finance do
  ...
  # alias Stockex.Finance.Dataframe
  @doc """
  ...
  """
  def get_stock(%{ name: name, date: date }) do
    res = Stock.regression(%{ name: name, date: date })
    # api_response = Stock.from_json(%{ name: name, data: quandl_data.body })
    # api_response2 = Dataframe.from_json(%{ name: name, data: quandl_data.body })
  end
